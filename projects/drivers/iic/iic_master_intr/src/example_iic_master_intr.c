...
/******************************************************************************
 * @file     example_iic_master_no-blocking.c
 * @brief    the main function for the IIC master no-blocking driver
 * @version  V1.0
 * @date     5. Jan 2020
 ******************************************************************************/
#include <stdio.h>
...
int test_iic_eeprom(int32_t iic_idx)
{
    ...
    printf("\n test at24c64 send and receive intr passed\n");
