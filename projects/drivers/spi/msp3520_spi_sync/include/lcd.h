...
#define	LCD_LED led_ioctl(1) //LCD背光    		 
...
#define	LCD_CS_SET  ioctl(1) //GPIO_TYPE->BSRRL=1<<LCD_CS    //片选端口  	PB11
#define	LCD_RS_SET	dc_ioctl(1) //GPIO_TYPE->BSRRL=1<<LCD_RS    //数据/命令  PB10	  
#define	LCD_RST_SET	rst_ioctl(1) //GPIO_TYPE->BSRRL=1<<LCD_RST    //复位			PB12

 							    
#define	LCD_CS_CLR  ioctl(0) //GPIO_TYPE->BSRRH=1<<LCD_CS     //片选端口  	PB11
#define	LCD_RS_CLR	dc_ioctl(0) //GPIO_TYPE->BSRRH=1<<LCD_RS     //数据/命令  PB10	 
#define	LCD_RST_CLR	rst_ioctl(0) //GPIO_TYPE->BSRRH=1<<LCD_RST    //复位			  PB12
