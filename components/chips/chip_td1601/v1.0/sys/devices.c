...
const uint16_t spi_tx_hs_num[2]  = {9, 7};
const uint16_t spi_rx_hs_num[2]  = {8, 6};
...
const csi_pinmap_t adc_pinmap[] = {
    ...
    {PA8,           0,     5,           PA8_ADC_A6 },
    {PA9,           0,     6,           PA9_ADC_A7 },
    {PA15,          0,     8,           PA15_ADC_A9 },
    {PA16,          0,     9,           PA16_ADC_A10 },
    {PA17,          0,     10,          PA17_ADC_A11 },
    {PA18,          0,     12,          PA18_ADC_A13 },
    {PA19,          0,     7,           PA19_ADC_A8 },
    {PB2,           1,     14,          PB2_ADC1_A15 },
    {PB4,           1,     6,           PB4_ADC1_A7 },
    {PB5,           1,     8,           PB5_ADC1_A9 },
    {PB6,           1,     9,           PB6_ADC1_A10 },
    {PB7,           1,     10,          PB7_ADC1_A11 },
    {PB8,           1,     11,          PB8_ADC1_A12 },
    {PB13,          1,     7,           PB13_ADC1_A8 },
    {PB14,          0,     13,          PB14_ADC_A14 },
    {PB15,          0,     11,          PB15_ADC_A12 },
    {PB18,          1,     12,          PB18_ADC1_A13 },
    {PB19,          1,     13,          PB19_ADC1_A14 },
    {PB21,          0,     14,          PB21_ADC_A15 },
    {PB22,          1,     0,           PB22_ADC1_A1 },
    {PB23,          1,     1,           PB23_ADC1_A2 },
    {PB28,          1,     2,           PB28_ADC1_A3 },
    {PB29,          1,     3,           PB29_ADC1_A4 },
    {PB30,          1,     4,           PB30_ADC1_A5 },
    {PB31,          1,     5,           PB31_ADC1_A6 },
...
const csi_pinmap_t uart_pinmap[] = {
    ...
    {PB0,             0,     PIN_UART_DE,    PB0_UART0_DE  },
    {PB1,             0,     PIN_UART_RE,    PB1_UART0_RE  },
    {PB2,             1,     PIN_UART_DE,    PB2_UART1_DE  },
    {PB3,             1,     PIN_UART_RE,    PB3_UART1_RE  },
    {PB12,            2,     PIN_UART_RX,    PB12_UART2_RXD  },
    {PB13,            2,     PIN_UART_TX,    PB13_UART2_TXD  },
    {PB14,            2,     PIN_UART_CTS,    PB14_UART2_CTS_N  },
    {PB15,            2,     PIN_UART_RTS,    PB15_UART2_RTS_N  },
    {PB16,            2,     PIN_UART_DE,    PB16_UART2_DE  },
    {PB17,            2,     PIN_UART_RE,    PB17_UART2_RE  },
    {PB18,            3,     PIN_UART_RX,    PB18_UART3_RXD  },
    {PB19,            3,     PIN_UART_TX,    PB19_UART3_TXD  },
    {PB20,            3,     PIN_UART_CTS,    PB20_UART3_CTS_N  },
    {PB21,            3,     PIN_UART_RTS,    PB21_UART3_RTS_N  },
    {0xFFFFFFFFU, 0xFFU, 0xFFU,      0xFFFFFFFFU  },
};
