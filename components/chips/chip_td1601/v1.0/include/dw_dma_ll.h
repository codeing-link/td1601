...
{
    dma->CTL &= ~((uint64_t)DW_DMA_CTL_SRT_TR_WIDTH_Msk);
...
{
    dma->CTL &= ~((uint64_t)DW_DMA_CTL_DINC_Msk);
    dma->CTL  |= (value << DW_DMA_CTL_DINC_Pos);
}
...
{
    dma->CTL &= ~((uint64_t)DW_DMA_CTL_SINC_Msk);
    dma->CTL  |= (value << DW_DMA_CTL_SINC_Pos);
}
...
{
    dma->CTL &= ~((uint64_t)DW_DMA_CTL_DEST_MSIZE_Msk);
...
{
    dma->CTL &= ~((uint64_t)DW_DMA_CTL_SRC_MSIZE_Msk);
...
{
    dma->CTL &= ~((uint64_t)DW_DMA_CTL_TT_FC_Msk);
...
{
    dma->CFG  &= ~((uint64_t)DW_DMA_CFG_CH_PRIOR_Msk);
...
{
    dma->CFG &= ~((uint64_t)DW_DMA_CFG_CH_SUSP_En);
}
...
{
    dma->CFG &= ~((uint64_t)DW_DMA_CFG_HS_SEL_DST_En);
}
...
{
    dma->CFG &= ~((uint64_t)DW_DMA_CFG_HS_SEL_SRC_En);
}
...
{
    dma->CFG &= ~((uint64_t)DW_DMA_CFG_LOCK_CH_En);
}
...
{
    dma->CFG &= ~((uint64_t)DW_DMA_CFG_LOCK_B_En);
}
...
{
    dma->CFG &= ~((uint64_t)DW_DMA_CFG_DST_HS_POL_En);
}
...
{
    dma->CFG &= ~((uint64_t)DW_DMA_CFG_SRC_HS_POL_En);
}
...
{
    dma->CFG &= ~((uint64_t)DW_DMA_CFG_RELOAD_SRC_En);
}
...
{
    dma->CFG &= ~((uint64_t)DW_DMA_CFG_RELOAD_DST_En);
}
...
{
    dma->CFG &= ~((uint64_t)DW_DMA_CFG_FCMODE_En);
}
...
{
    dma->CFG &= ~((uint64_t)DW_DMA_CFG_FIFO_MODE_En);
}
...
{
    dma->CFG  &= ~((uint64_t)DW_DMA_CFG_SRC_PER_Msk);
...
{
    dma->CFG  &= ~((uint64_t)DW_DMA_CFG_DEST_PER_Msk);
