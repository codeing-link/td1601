...
#ifdef GD25Q32E
    {
        .flash_name  = ( char * )"gd25q32e",
        .flash_id    = 0x00c84016U,
        .addr_mode   = FLASH_ADDR_24,
        .flash_size  = ( uint32_t )( 4 * 1024 * 1024 ),
        .sector_size = ( uint32_t )( 4 * 1024 ),
        .page_size   = 256U,
        .has_lock    = 1U,
        .region      = (uint32_t)LOCK_TP_DUAL,
...
#ifdef GD25WQ32E
    {
        .flash_name  = ( char * )"gd25wq32e",
        .flash_id    = 0x00c86516U,
        .addr_mode   = FLASH_ADDR_24,
        .flash_size  = ( uint32_t )( 4 * 1024 * 1024 ),
        .sector_size = ( uint32_t )( 4 * 1024 ),
        .page_size   = 256U,
...
#ifdef MT25QU256ABA
    {
        .flash_name  = ( char * )"mt25qu256aba",
        .flash_id    = 0x20bb19U,
        .addr_mode   = FLASH_ADDR_24,
        .flash_size  = ( uint32_t )( 32 * 1024 * 1024 ),
        .sector_size = ( uint32_t )( 4 * 1024 ),
        .page_size   = 256U,
        .has_lock    = 1U,
        .region      = (uint32_t)LOCK_TP_TOP,
        .bp_bits     = 4U,
        .base_protect_size = ( uint32_t )( 64 * 1024 ),
        .qe_pos      = 3U,
        .sr_count    = 2U
...
#ifdef MT25QL512ABA
    {
        .flash_name  = ( char * )"mt25ql512aba",
        .flash_id    = 0x20ba20U,
        .addr_mode   = FLASH_ADDR_24,
        .flash_size  = ( uint32_t )( 64 * 1024 * 1024 ),
        .sector_size = ( uint32_t )( 4 * 1024 ),
        .page_size   = 256U,
        .has_lock    = 1U,
        .region      = (uint32_t)LOCK_TP_TOP,
...
#ifdef IS25LP080D
    {
        .flash_name  = ( char * )"is25lp080d",
        .flash_id    = 0x009d6014U,
        .addr_mode   = FLASH_ADDR_24,
        .flash_size  = ( uint32_t )( 1 * 1024 * 1024 ),
        .sector_size = ( uint32_t )( 4 * 1024 ),
        .page_size   = 256U,
        .has_lock    = 1U,
        .region      = (uint32_t)LOCK_TP_DUAL,
...
#ifdef IS25LP032D
    {
        .flash_name  = ( char * )"is25lp032d",
        .flash_id    = 0x0009d6016U,
        .addr_mode   = FLASH_ADDR_24,
        .flash_size  = ( uint32_t )( 4 * 1024 * 1024 ),
        .sector_size = ( uint32_t )( 4 * 1024 ),
        .page_size   = 256U,
...
#ifdef XT25F32F
    {
        .flash_name  = ( char * )"xt25f32f",
        .flash_id    = 0x000b4016U,
        .addr_mode   = FLASH_ADDR_24,
        .flash_size  = ( uint32_t )( 4 * 1024 * 1024 ),
        .sector_size = ( uint32_t )( 4 * 1024 ),
        .page_size   = 256U,
