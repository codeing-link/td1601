...
typedef struct {
    ...
    /* task run time on current & previous time block */
    sys_time_t       task_block_time_run;
    sys_time_t       task_block_time_run_pre;
    /* the time block in which the task last run */
    lr_timer_t       compare_block_times;
#endif
